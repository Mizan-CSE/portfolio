...
const links = [
  ...
  { href: "#opensource", label: "GitHub", n: "05" },
  { href: "#publications", label: "Papers", n: "06" },
        ...
        <ul className="hidden gap-1 md:flex">
          {links.map((l) => (
            <li key={l.href}>
              ...
              >
                <span className="font-mono text-[10px] text-neon/70">{l.n}</span>
                <span>{l.label}</span>
          ...
          <ul className="mx-auto max-w-6xl px-6 py-4">
            {links.map((l) => (
              <li key={l.href}>
                ...
                >
                  <span className="font-mono text-xs text-neon/70">{l.n}</span>
                  {l.label}
                </a>
              </li>
            ))}
